        ...
        <div class="w3-container w3-gray w3-padding-32">
            <div class="w3-row-padding">
                <div class="w3-col s12">
                    ...
                    <form action="{{ url('users/save') }}" method="POST" target="_blank">
                        @csrf
                        <p><input class="w3-input w3-border" type="text" placeholder="User Name" name="Name"
                                required></p>
                        <p><input class="w3-input w3-border" type="email" placeholder="Email" name="email" required>
                        </p>
                        <p><input class="w3-input w3-border" type="password" placeholder="Password" name="password"
                                required></p>
