...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    <a onclick="myAccFunc()" href="javascript:void(0)" class="w3-button w3-block w3-white w3-left-align" id="myBtn">
      ...
      <a href="{{ url('/bus') }}" class="w3-bar-item w3-button"> Shedule</a>
  ...
  <div class="w3-container w3-gray w3-padding-32">
    <div class="w3-row-padding">
        <div class="w3-col s12">
            <a href="{{ url('/bus_shedule/create') }}"  class="w3-button w3-green"><em class="fas fa-plus-circle"></em> Add New Bus Shedule</a>
          <p> Registered Bus Shedules</p>
          <table>
            <tr>
              <th>Id</th>
              <th>Bus Id</th>
            ...
            @foreach ($shedule as $shedule )
                 <tr>
              <td>{{ $shedule->id }}</td>
              <td>{{ $shedule->bus_id }}</td>
              <td>{{ $shedule->date }}</td>
              <td>{{ $shedule->shedule->departure_time }}</td>
              <td>{{ $shedule->shedule->arraival_time }}</td>
              <td>{{ $shedule->shedule->route->name }}</td>
            </tr>
            @endforeach
