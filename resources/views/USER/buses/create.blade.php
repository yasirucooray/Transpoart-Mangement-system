  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    <a onclick="myAccFunc()" href="javascript:void(0)" class="w3-button w3-block w3-white w3-left-align" id="myBtn">
      ...
      <div id="demoAcc" class="w3-bar-block w3-hide w3-padding-large w3-medium">
        ...
        <a href="{{ url('/bus/create') }}" class="w3-bar-item w3-button w3-light-grey"><i class="fa fa-caret-right w3-margin-right"></i>Add Buses</a>
      </div>
  ...
  <div class="w3-container w3-gray w3-padding-32">
    <div class="w3-row-padding">
        <div class="w3-col s12">
           <h4>Add New Busses</h4>

          <form action="{{ url('bus/save') }}" method="POST" target="_blank">
            @csrf
            <p><input class="w3-input w3-border" type="text" placeholder="Bus Number" name="Name" required></p>
            ...
            <p><input class="w3-input w3-border" type="text" placeholder="Owner Name" name="owner_Name" required></p>
