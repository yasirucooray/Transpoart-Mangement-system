  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    <a onclick="myAccFunc()" href="javascript:void(0)" class="w3-button w3-block w3-white w3-left-align" id="myBtn">
      ...
      <div id="demoAcc" class="w3-bar-block w3-hide w3-padding-large w3-medium">
        <a href="{{ url('/bus') }}" class="w3-bar-item w3-button w3-light-grey"><i class="fa fa-caret-right w3-margin-right"></i> Buses List</a>
  ...
  <div class="w3-container w3-gray w3-padding-32">
    <div class="w3-row-padding">
        <div class="w3-col s12">
            <a href="{{ url('/bus/create') }}"  class="w3-button w3-green"><em class="fas fa-plus-circle"></em> Add New Bus</a>
         ...
         <td>{{ $bus->id }}</td>
         <td>{{ $bus->bus_no }}</td>
         <td>{{ $bus->infor->owner_name }}</td>
         <td>{{ $bus->infor->phone }}</td>
       </tr>
       @endforeach
          </table>
        </div>
