        ...
        <div class="w3-container w3-gray w3-padding-32">
            <div class="w3-row-padding">
                <div class="w3-col s12">
                    <a href="{{ url('/bus/create') }}" class="w3-button w3-green"><em class="fas fa-plus-circle"></em>
                        Add New Bus</a>
                    ...
                    <table>
                        ...
                        @foreach ($buses as $bus)
                            <tr>
                                ...
                                <td> <a href="{{ url('/bus/' . $bus->id . '/edit') }}"
                                        class="w3-button w3-yellow">Edit</a>
                                    <form action="{{ url('/bus/' . $bus->id . '/delete') }}" target="_blank"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
