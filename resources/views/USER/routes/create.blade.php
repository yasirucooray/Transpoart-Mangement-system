  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    <a onclick="myAccFunc()" href="javascript:void(0)" class="w3-button w3-block w3-white w3-left-align" id="myBtn">
      ...
      <div id="demoAcc2" class="w3-bar-block w3-hide w3-padding-large w3-medium">
        <a href="{{ url('/route') }}" class="w3-bar-item w3-button w3-light-grey"><i class="fa fa-caret-right w3-margin-right"></i> Routes List</a>
  ...
  <div class="w3-container w3-gray w3-padding-32">
    <div class="w3-row-padding">
        <div class="w3-col s12">
          ...
          <form action="{{ url('route/create') }}" target="_blank" method="POST">
            @csrf
            <p><input class="w3-input w3-border" type="text" placeholder="Route Name" name="Name" required></p>

            <p><input class="w3-input w3-border" type="text" placeholder="Distance" name="distance" required></p>
            <p><input class="w3-input w3-border" type="text" placeholder="Bus Count" name="count" required></p>
            <p><input class="w3-input w3-border" type="text" placeholder="Stand one" name="s_one" required></p>
            <p><input class="w3-input w3-border" type="text" placeholder="Stand Two" name="s_two" required></p>
