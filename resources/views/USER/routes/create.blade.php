            ...
            <div class="w3-row-padding">
                <div class="w3-col s12">
                    ...
                    <form action="{{ url('route/create') }}" target="_blank" method="POST">
                        @csrf
                        <p><input class="w3-input w3-border" type="text" placeholder="Route Name" name="Name"
                                required></p>

                        <p><input class="w3-input w3-border" type="text" placeholder="Distance" name="distance"
                                required></p>
                        <p><input class="w3-input w3-border" type="text" placeholder="Bus Count" name="count"
                                required></p>
                        <p><input class="w3-input w3-border" type="text" placeholder="Stand one" name="s_one"
                                required></p>
                        <p><input class="w3-input w3-border" type="text" placeholder="Stand Two" name="s_two"
                                required></p>
