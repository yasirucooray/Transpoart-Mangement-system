        ...
        <div class="w3-container w3-gray w3-padding-32">
            <div class="w3-row-padding">
                <div class="w3-col s12">
                    <a href="{{ url('/route/create') }}" class="w3-button w3-green"><em class="fas fa-plus-circle"></em>
                        Add New Routes</a>
                    ...
                    <table>
                        ...
                        @foreach ($routes as $route)
                            <tr>
                                ...
                                <td> <a href="{{ url('/route/' . $route->id . '/edit') }}"
                                        class="w3-button w3-yellow">Edit</a>
                                    <form action="{{ url('/route/' . $route->id . '/delete') }}" target="_blank"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
