  ...
  <div class="w3-container w3-gray w3-padding-32">
    <div class="w3-row-padding">
        <div class="w3-col s12">
            <a href="{{ url('/shedule/create') }}"  class="w3-button w3-green"><em class="fas fa-plus-circle"></em> Add New Shedule</a>
          <p> Registered Shedules</p>
          <table>
            <tr>
              <th>Id</th>
            ...
            @foreach ($shedule as $shedule )
                 <tr>
              <td>{{ $shedule->id }}</td>
              <td>{{ $shedule->departure_time }}</td>
              <td>{{ $shedule->arraival_time }}</td>
              <td>{{ $shedule->route->name }}</td>
            </tr>
            @endforeach
