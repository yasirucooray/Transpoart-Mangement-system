...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    ...
    <a href="{{ url('/shedule') }}" class="w3-bar-item w3-button w3-light-grey"><i class="fa fa-caret-right w3-margin-right"></i>Shedule</a>
          ...
          <form action="{{ url('shedule/save') }}" target="_blank" method="POST">
            ...
            <p><select class="w3-input w3-border" aria-placeholder="select Route"  name="route">
                @foreach ($route as $rout )
                    <option class="w3-input w3-border" value={{ $rout->id }} >{{ $rout->name }}</option>
                @endforeach

                </select>

            </p>
            <p><input class="w3-input w3-border" type="time" placeholder="Departure Time" name="d_time" required></p>
            <p><input class="w3-input w3-border" type="time" placeholder="Arrival Time" name="a_time" required></p>
